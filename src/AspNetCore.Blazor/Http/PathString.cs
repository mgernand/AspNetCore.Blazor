...
// See: https://github.com/dotnet/aspnetcore/blob/main/src/Http/Http.Abstractions/src/PathString.cs
...
namespace Microsoft.AspNetCore.Http
{
	...
	public readonly struct PathString : IEquatable<PathString>
	{
		...
		public PathString(string? value)
		{
			...
			{
				throw new ArgumentException($"The path in '{nameof(value)}' must start with '/'.");
			}
			Value = value;
		}
